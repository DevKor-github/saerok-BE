...
public class BirdFullSyncResponse {
    ...
    public static class BirdProfileItem {
        ...
        @Schema(description = "한글 이름", example = "참새")
        private String koreanName;

        @Schema(description = "학명", example = "Passer montanus")
        private String scientificName;

        @Schema(description = "학명 저자", example = "Linnaeus")
        private String scientificAuthor;

        @Schema(description = "학명 연도", example = "1758")
