...
@Schema(description = "커뮤니티 동정 요청 컬렉션 정보")
public record CommunityPendingCollectionInfo(
        ...
        @Schema(description = "동정 돕기에 참여한 유저 수", example = "5")
    ...
    @Schema(name = "CommunityPendingCollectionInfo.BirdInfo")
    ...
    @Schema(name = "CommunityPendingCollectionInfo.UserInfo")
