...
class CollectionQueryServiceTest {
    ...
    void getCollectionDetail_public_anonymous() throws IllegalAccessException {
        ...
        String objectKey = "collection-images/42/uuid";
        ...
        given(collectionImageRepository.findObjectKeysByCollectionId(collectionId))
                .willReturn(List.of(objectKey));
        ...
        given(collectionCommentRepository.countByCollectionId(collectionId))
                .willReturn(3L);
        given(imageDomainService.toUploadImageUrl(objectKey))
                .willReturn(imageUrl);
