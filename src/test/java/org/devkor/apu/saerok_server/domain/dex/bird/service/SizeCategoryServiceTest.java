...
import org.devkor.apu.saerok_server.domain.dex.bird.builder.BirdProfileTestBuilder;
...
class SizeCategoryServiceTest {
    ...
    void getSizeCategory_경계값테스트(Double lenStr, String expectedCode, String expectedLabel) {
        // given
        HasBodyLength bird = new BirdProfileTestBuilder().bodyLengthCm(lenStr).build();
